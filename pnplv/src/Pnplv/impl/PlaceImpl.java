 ...
 * </p>
 * <ul>
 *   <li>{@link Pnplv.impl.PlaceImpl#getTokens <em>Tokens</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlaceImpl extends ElementImpl implements Place {
	...
	protected EClass eStaticClass() {
		return PnplvPackage.Literals.PLACE;
	}
	...
	public void setTokens(int newTokens) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnplvPackage.PLACE__TOKENS, oldTokens, tokens));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PnplvPackage.PLACE__TOKENS:
				return getTokens();
		}
