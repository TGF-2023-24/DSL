 ...
 * </p>
 * <ul>
 *   <li>{@link pnpl_variability.impl.PetriNetImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PetriNetImpl extends MinimalEObjectImpl.Container implements PetriNet {
	...
	protected EClass eStaticClass() {
		return Pnpl_variabilityPackage.Literals.PETRI_NET;
	}
	...
	public EList<Element> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<Element>(Element.class, this, Pnpl_variabilityPackage.PETRI_NET__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pnpl_variabilityPackage.PETRI_NET__ELEMENTS:
