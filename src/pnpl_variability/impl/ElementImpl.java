 ...
 * </p>
 * <ul>
 *   <li>{@link pnpl_variability.impl.ElementImpl#getPresenceCondition <em>Presence Condition</em>}</li>
 *   <li>{@link pnpl_variability.impl.ElementImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ElementImpl extends MinimalEObjectImpl.Container implements Element {
	...
	protected EClass eStaticClass() {
		return Pnpl_variabilityPackage.Literals.ELEMENT;
	}
		...
		if (presenceCondition != null && presenceCondition.eIsProxy()) {
			...
			if (presenceCondition != oldPresenceCondition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Pnpl_variabilityPackage.ELEMENT__PRESENCE_CONDITION, oldPresenceCondition, presenceCondition));
			}
		}
	...
	public void setPresenceCondition(PresenceCondition newPresenceCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pnpl_variabilityPackage.ELEMENT__PRESENCE_CONDITION, oldPresenceCondition, presenceCondition));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pnpl_variabilityPackage.ELEMENT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pnpl_variabilityPackage.ELEMENT__PRESENCE_CONDITION:
				if (resolve) return getPresenceCondition();
				return basicGetPresenceCondition();
			case Pnpl_variabilityPackage.ELEMENT__NAME:
				return getName();
		}
