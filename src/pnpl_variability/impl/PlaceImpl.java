 ...
 * </p>
 * <ul>
 *   <li>{@link pnpl_variability.impl.PlaceImpl#getTokens <em>Tokens</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlaceImpl extends ElementImpl implements Place {
	...
	protected EClass eStaticClass() {
		return Pnpl_variabilityPackage.Literals.PLACE;
	}
	...
	public void setTokens(int newTokens) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pnpl_variabilityPackage.PLACE__TOKENS, oldTokens, tokens));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pnpl_variabilityPackage.PLACE__TOKENS:
				return getTokens();
		}
